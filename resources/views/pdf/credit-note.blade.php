...
@section('title', 'Nota de Crédito Electrónica')
...
@section('content')
    ...
    <!-- Affected Document Info -->
    <div class="client-section">
        <div class="section-title">DOCUMENTO AFECTADO</div>
        <div class="client-row">
            <div class="client-label">Tipo Documento:</div>
            <div class="client-value">{{ $documento_afectado['tipo'] }}</div>
        </div>
        <div class="client-row">
            <div class="client-label">Número:</div>
            <div class="client-value">{{ $documento_afectado['numero'] }}</div>
        </div>
        <div class="client-row">
            <div class="client-label">Motivo:</div>
            <div class="client-value">{{ $motivo['descripcion'] }}</div>
        </div>
    </div>

...
@section('title', 'Boleta de Venta Electrónica')
...
@section('content')
    ...
    <div class="client-section">
        ...
        @if(!empty($client['numero_documento']) && $client['numero_documento'] != '-')
        <div class="client-row">
            <div class="client-label">{{ $client['tipo_documento'] == '1' ? 'DNI:' : 'Doc:' }}</div>
    ...
    <div class="footer">
        <div class="small">
            ...
            - Esta boleta se encuentra almacenada electrónicamente en SUNAT.<br>

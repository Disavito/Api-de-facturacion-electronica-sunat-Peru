...
<head>
  <meta charset="UTF-8">
  <title>Guía de Remisión Electrónica - A5</title>
  <style>
    /* ================= BASE ================= */
    body {
...
<body>
  <div class="container">
    ...
    <!-- OBSERVACIONES -->
    <div style="margin-top: 10px; padding: 6px; border: 1px solid #ccc; border-radius: 4px; background-color: #f9f9f9; font-size: 7px;">

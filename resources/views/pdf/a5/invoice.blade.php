...
<head>
  <meta charset="UTF-8">
  <title>Factura Electrónica - A5</title>
  <style>
    /* ================= BASE ================= */
    body {
    ...
    <div class="datos">
      ...
      <div>
        <p>
          ...
          <b>FECHA VENCTO:</b> {{ $fecha_vencimiento ?? '-' }}<br>
        ...
        <td rowspan="7" style="width: 60%;">
          <div class="qr-info-container">
            <div class="qr">
              ...
              @else
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=70x70&data={{ urlencode($document->numero_completo ?? 'Factura') }}" alt="Código QR">
              @endif
            </div>

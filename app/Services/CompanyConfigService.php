...
class CompanyConfigService
{
    ...
    public function getCompanyConfiguration(Company $company, bool $useCache = true): array
    {
        ...
        $config = [
            ...
            'services' => $company->getConfig('servicios_sunat', []),
            ...
            'configuraciones_adicionales' => [
                'resumenes_diarios' => $company->getConfig('resumenes_diarios', []),
                'comunicaciones_baja' => $company->getConfig('comunicaciones_baja', []),
                'notificaciones' => $company->getConfig('notificaciones', []),
                'seguridad' => $company->getConfig('seguridad', []),
            ],
